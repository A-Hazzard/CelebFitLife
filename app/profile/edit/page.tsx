...
export default function EditProfilePage() {
  ...
  const [avatarUrl, setAvatarUrl] = useState("/path/to/profile.jpg");
    ...
    <div className="min-h-screen bg-brandBlack text-brandWhite flex items-center justify-center">
      <div className="max-w-lg w-full bg-brandGray p-6 rounded-lg shadow-lg">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <input
            type="file"
            className="text-sm text-brandWhite"
        ...
        <div className="mt-6 flex justify-center">
          <Button
            className="bg-brandOrange text-brandBlack px-6 py-2 rounded-full"
            onClick={handleSave}
          >
            Save Changes
          </Button>
