...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen">
        ...
        <div className="absolute inset-0 w-full h-full">
          <Image
            ...
            fill
            className="object-cover object-center lg:object-[center_30%] xl:object-[center_25%] 2xl:object-[center_20%] xl:!w-1/2 xl:!left-1/4"
            priority
          />
        ...
        {/* Navigation */}
        <nav className="relative z-10 flex items-center justify-between px-6 lg:px-40 py-12">
      ...
      {/* Features Section */}
      <section className="px-6 lg:px-56 py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="relative group">
            <div className="relative h-[507px] rounded-lg overflow-hidden">
              <Image
              ...
              <div className="absolute bottom-8 left-8 right-8">
                ...
                <p className="text-white text-lg font-normal uppercase tracking-wide leading-tight">
          ...
          <div className="relative group">
            <div className="relative h-[507px] rounded-lg overflow-hidden">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                ...
                <p className="text-white text-lg font-normal uppercase tracking-wide leading-tight">
                  GET ANSWERS MID-SESSIONS AND DURING COOL DOWN
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="px-6 lg:px-40 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-5xl font-bold text-gray-100 mb-8">HOW IT WORKS?</h2>
          ...
          <div className="space-y-6">
            {/* Step 1 */}
            <div className="step-card rounded-3xl p-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-100 mb-2">Sign up</h3>
                  <p className="text-gray-300 text-lg">Join the waitlist to claim your spot before it fills.</p>
                </div>
              </div>
            </div>
            ...
            <div className="step-card rounded-3xl p-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-100 mb-2">Get Notified</h3>
                  <p className="text-gray-300 text-lg">We&apos;ll email you well in advance with everything you need to join your first live session.</p>
                </div>
              </div>
            </div>
            ...
            <div className="step-card rounded-3xl p-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-100 mb-2">Train Live</h3>
                  <p className="text-gray-300 text-lg">Follow along, ask questions, and sweat side-by-side with your idols... in real time.</p>
                </div>
              </div>
            </div>
            ...
            <div className="step-card rounded-3xl p-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-100 mb-2">Watch your Gains</h3>
                  <p className="text-gray-300 text-lg">Watch yourself getting jacked while observing yourself ho finally reach the fitness goals you set.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="px-6 lg:px-40 py-24">
        <div className="text-center mb-16">
          <p className="text-gray-500 text-sm uppercase tracking-widest mb-8">WANT TO KNOW MORE?</p>
          <h2 className="text-5xl font-bold text-gray-100">FREQUENTLY ASKED QUESTIONS</h2>
        </div>

        <div className="max-w-4xl mx-auto space-y-3">
          {/* FAQ Item 1 - Expanded */}
          <div className="faq-item rounded-2xl p-6">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-xl font-medium text-white">Lorem ipsum dolor sit amet consectetur. Id molestie?</h3>
          ...
          {[
            ...
            <div key={index} className="faq-item rounded-2xl p-6">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-600 bg-black px-6 lg:px-56 py-12">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
          <div>
            <svg width="142" height="28" viewBox="0 0 142 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-6">
            ...
            <nav className="flex gap-8 mb-8">
              <a href="#" className="text-gray-300 hover:text-white">Waitlist</a>
            ...
            <p className="text-white">© CelebFit 2025</p>
          </div>
